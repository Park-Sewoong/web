...
const RotationEncryptor = {
    ...
    //   let splittedArray = this.message.split('')     //문자열 나눌때 split 사용 ["a", "b", "c", "d", "e"]
    //   let mappedArray = splittedArray.map( c => 
    //       String.fromCharCode(c.charCodeAt(0) + this.rotation) // ["b", "c", "d", "e", "f"]
    //   )
    //   let joinedString = mappedArray.join("") // "bcdef"
    //   return joinedString;
